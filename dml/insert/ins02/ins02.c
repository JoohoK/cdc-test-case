	  ...
	  if (j % interval == 0)
		...
		case 1:
		  ...
		  for (k = 0; k < data_item->dml.num_changed_column; k++)
		    ...
		    printf ("\t\tchanged_column_data[%d]: %lf\n", 1, *(double*)data_item->dml.changed_column_data[1]);
		    printf ("\t\tchanged_column_data[%d]: %f\n", 2, *(float*)data_item->dml.changed_column_data[2]);
		    printf ("\t\tchanged_column_data[%d]: %d\n", 3, *(short*)data_item->dml.changed_column_data[3]);
		    printf ("\t\tchanged_column_data[%d]: %lld\n", 4, *(int64_t*)data_item->dml.changed_column_data[4]);
                  }
		  ...
		  for (k = 0; k < data_item->dml.num_cond_column; k++)
		    {
		      printf ("\t\tcond_column_data[%d]       : %d\n", k, *(int*)data_item->dml.cond_column_data[k]);
		    }
